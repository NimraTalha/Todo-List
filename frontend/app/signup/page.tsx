        ...
        <div className="flex justify-center">
          <div className="w-full max-w-md">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-300">Start managing your tasks efficiently today</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 dark:bg-dark-800 dark:text-white">
              ...
              <div className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link href="/login" className="font-medium text-primary-600 hover:text-primary-500 transition-colors dark:text-primary-400 dark:hover:text-primary-300">
                  Sign in here
                </Link>
              </div>

              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-dark-700">
                <div className="text-xs text-gray-500 text-center space-y-1 dark:text-gray-400">
